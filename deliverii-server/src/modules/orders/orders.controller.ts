...
import { Controller, Post, Body, Get, UseGuards, HttpCode, Put, Param, Delete, HttpStatus, HttpException, Inject, Patch, Query } from '@nestjs/common';
import { ApiUnauthorizedResponse, ApiOkResponse, ApiTags, ApiBearerAuth, ApiOperation, ApiNoContentResponse, ApiNotFoundResponse, ApiBadRequestResponse, ApiCreatedResponse, ApiForbiddenResponse, ApiUnprocessableEntityResponse, ApiQuery } from '@nestjs/swagger';
...
export class OrdersController {
    ...
    async getOrders(
      ...
      return await this.ordersService.getAll(user, restaurantID);
    }
